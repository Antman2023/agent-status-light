...
边缘吸附默认启用。把悬浮灯拖到屏幕工作区边缘附近或拖出屏幕后松开，它会自动吸附并收缩为简略灯条。吸附在上、下边缘时，红、黄、绿三段从左到右排列，并可沿边缘左右拖动；吸附在左、右边缘时，三段从上到下排列，并可沿边缘上下拖动。沿边拖动不会展开灯条，把灯条向屏幕内部拖动即可恢复完整指示灯，也可以在右键菜单关闭边缘吸附。
